...
- `05_item_mapping_master.csv`：40共通品目に対する初期237条件枝
...
区分網羅性は、公式総数一致なら `official_category_count`、公式総数がない手動目次照合なら `reviewed_category_count` を使用します。後者で公式総数を捏造してはいけません。
