...
def main() -> int:
    ...
    checks.append(("all ten reviewed municipalities pass QA", all(
    ...
    yura_urls = {row["公式URL"] for row in sources if row["municipality_id"] == "M028"}
    ...
    ), "resident-facing source + 2026 calendar must both be retained"))
