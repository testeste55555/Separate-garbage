...
TARGETS = {"M055", "M068", "M076", "M098", "M099", "M100", "M120", "M123", "M127", "M136", "M139"}
CURRENT_SOURCE = {"CURRENT", "現行", "現行案内中"}
STANDARD_SCOPE_VARIANT_TARGETS = {"M055", "M068"}
...
NEW_EXPECTED_LABELS = {
    "LV-M068-01": ["資源ごみ", "資源ごみ", "資源ごみ", "燃やせるごみ", "資源ごみ", "資源ごみ", "資源ごみ", "使用済み乾電池", "埋立ごみ", "燃やせるごみ"],
