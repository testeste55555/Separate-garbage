...
| `validate_lesson_scoring_modes.py` | APP_READY 40品目とLESSON_READY_10固定10品目のscope・全条件枝・公式根拠・UI境界、および非BOX preflight blockerを共通検証 |
| `red_team_lesson_scoring_modes.py` | 欠落枝・二重scoring・根拠欠落・偽APP_READY・blocker自治体のscope混入等をmutation検査 |
