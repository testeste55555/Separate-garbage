...
- `WORK_ゴミ出し情報収集フロー_143自治体_v1.24.txt`：**現行版**。MASTER固定143自治体の初回category研究一巡完了後の運用基準。地域variantの排出容器・経路差、行単位の出典整合性、category完了とAPP_READYの分離を最終固定
...
- category：1,594行（構造化公式葉1,464区分）
- source：368
- item mapping：1,322条件枝
- coverage：5,280 pair
